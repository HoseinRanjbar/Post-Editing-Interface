...
def run_remote(video_address, ref_img_address, output_path, video_size):
    ...
    video_remote_file_path = config['s3it']['working_directory']+'/assets/videos/video.mp4'
    ref_img_remote_file_path = config['s3it']['working_directory']+'/assets/images/image.png'
